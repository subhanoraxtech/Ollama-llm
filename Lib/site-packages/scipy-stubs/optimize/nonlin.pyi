...
class BroydenFirst:
    def __init__(self, /, alpha: object = None, reduction_method: object = "restart", max_rank: object = None) -> None: ...
    def todense(self, /) -> object: ...
    def solve(self, /, f: object, tol: object = 0) -> object: ...
    def matvec(self, /, f: object) -> object: ...
    def rsolve(self, /, f: object, tol: object = 0) -> object: ...
...
class KrylovJacobian:
    def __init__(
        ...
        /,
        rdiff: object = None,
        method: object = "lgmres",
        inner_maxiter: object = 20,
        inner_M: object = None,
        outer_k: object = 10,
        **kw: object,
    ) -> None: ...
    def matvec(self, /, v: object) -> object: ...
    def solve(self, /, rhs: object, tol: object = 0) -> object: ...
